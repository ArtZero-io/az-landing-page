  ...
  return (
    <React.Fragment>
      ...
      <section id="airdrop" className="airdrop">
        <img alt="stars" src="/assets/stars.png" className="stars-left" />
        <img alt="ufo" src="/assets/ufo-ellipse.svg" className="ufo-ellipse" />
        <img alt="ufo" src="/assets/ufo.png" className="ufo" />
        <img alt="stars" src="/assets/stars.png" className="stars-right" />
        <img alt="ground" src="/assets/ground.png" className="ground" />
      ...
      <section id="nft" className="nft">
        <img className="bg" alt="bg" src="/assets/bg-nft.png" />
          ...
          <div className="cards">
            <div className="card connect-wallet">
              ...
              <img
                className="icon"
                alt="icon"
                src="/assets/icon-connect-wallet.svg"
              />
            ...
            <div className="card create-nft">
              <img
                className="frame"
                alt="frame"
                src="/assets/frame-create-nft.svg"
              />
              <img
                className="icon"
                alt="icon"
                src="/assets/icon-create-nft.svg"
              />
            ...
            <div className="card create-collection">
              <img
                className="frame"
                alt="frame"
                src="/assets/frame-create-collection.svg"
              />
              <img
                className="icon"
                alt="icon"
              ...
              <div className="desc">
                Add social links, a description, profile and banner images, and
            ...
            <div className="card list-nft">
              <img
                className="frame"
                alt="frame"
                src="/assets/frame-list-nft.svg"
              />
              <img
                className="icon"
                alt="icon"
                src="/assets/icon-list-nft.svg"
              />
      ...
      <section id="roadmap" className="roadmap">
        <img alt="roadmap" src="/assets/roadmap-left.png" />
        <div className="main">
          <img className="grid" alt="roadmap" src="/assets/roadmap-grid.svg" />
          <h2>Roadmap</h2>
          <div className="desc">
        ...
        <img alt="roadmap" src="/assets/roadmap-right.png" />
      </section>

      <section id="partners" className="partners">
        <img className="bg" alt="bg" src="/assets/bg-partners.png" />
        <div className="heading">
          <h2>Partners</h2>
          <div className="desc">Friends along for a ride</div>
        </div>
        <div className="subwallet">
          <img alt="partners" src="/assets/partners-logo-subwallet.png" />
        </div>
      </section>
      ...
      <section id="advisors" className="advisors">
        <img alt="advisor" src="/assets/advisor-border-top.svg" />
        <div className="main">
          <div className="heading">
            <h2>Our Advisors</h2>
            <div className="desc">
          ...
          <div className="hieu">
            ...
            <div className="content">
              <img alt="advisor" src="/assets/advisor-hieu.png" />
          ...
          <div className="thong">
            <img className="bg" alt="advisor" src="/assets/advisor-frame.svg" />
            <div className="content">
              <img alt="advisor" src="/assets/advisor-thong.png" />
        ...
        <img alt="advisor" src="/assets/advisor-border-bottom.svg" />
      </section>

      <section id="subscribe" className="subscribe">
        <img className="bg" alt="bg" src="/assets/bg-subscribe.png" />
